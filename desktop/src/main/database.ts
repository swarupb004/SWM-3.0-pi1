...
export class DatabaseManager {
  ...
  async initialize() {
    ...
    // For existing databases being upgraded, the column is added without FK constraint.
    // This is a SQLite limitation - to properly add FK would require recreating the table.
    try {
